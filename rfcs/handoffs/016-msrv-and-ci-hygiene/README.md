...
**State.** Handoff 02 approved 2026-09-22 (`87bb1ec`).  **RFC 016 is complete**; it moves to `done/` at the 0.8.0 release.  Handoff 01 approved 2026-09-22 at r2 (`c536e12`, r2 `1be7cd5`, example lock `cff320e`).  Handoff 02 written 2026-09-22, from the r2 review: Dependabot moved only the pin whose comment named a version.
