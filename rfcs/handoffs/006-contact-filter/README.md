...
Review requests go to `.git-exclude/review-request/006-filter/`.

One unit: [01 — Filter hook and the layers table](./01-filter-hook.md).
Depends on RFC 005 handoff 01 (processing order settled).
