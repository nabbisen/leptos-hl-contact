...
Companion to [RFC 015](../../done/015-site-defined-fields.md).  Shared
...
**State.** Handoff 01 (spike) reviewed 2026-09-17: the map shape stands; RFC amended (A1–A7).  Handoffs 02–04 written 2026-09-17.  Handoffs 02 (`d07a69e`), 03 (`8d146fd`, `41a59ca`) and 04 (`90849a5`) approved 2026-09-22.  **RFC 015 shipped in 0.8.0** (tag `0.8.0`).
